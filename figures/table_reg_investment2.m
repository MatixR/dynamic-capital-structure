...
%
% - temporary file to simulate very constrained firms
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function table_reg_investment2(inst_id)
...
% 		plot(comparison);
	...
	filename = sprintf('simulation_outputs/table_reg_investment2_%02d.csv', inst_id);
