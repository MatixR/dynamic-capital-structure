function partial = partial_qD_partial_X(X, state0)
	...
	if (XD_this(2) <= XD_this(1)) && (XU_this(2) <= XU_this(1))
		...
		partial = partial_qD_partial_X_case1(X, state0);
		
	elseif (XD_this(2) <= XD_this(1)) && (XU_this(1) <= XU_this(2))
		
		partial = partial_qD_partial_X_case2(X, state0);

	elseif (XD_this(1) <= XD_this(2)) && (XU_this(2) <= XU_this(1))

		partial = partial_qD_partial_X_case3(X, state0);

	elseif (XD_this(1) <= XD_this(2)) && (XU_this(1) <= XU_this(2))

		partial = partial_qD_partial_X_case4(X, state0);
...
function partial = partial_qD_partial_X_case1(X, state0)
...
function partial = partial_qD_partial_X_case2(X, state0)
...
function partial = partial_qD_partial_X_case3(X, state0)
...
function partial = partial_qD_partial_X_case4(X, state0)
